...
public final class DisplayAddSourcePageAction extends Action {
  ...
  public ActionForward execute(ActionMapping mapping,
    ...
    try {
      ...
      List<org.jzkit.search.provider.iface.JZKitPluginMetadata> jzkit_plugins = (List) ctx.getBean("JZKitPluginRegistry");

      for ( Iterator i = jzkit_plugins.iterator(); i.hasNext(); ) {
