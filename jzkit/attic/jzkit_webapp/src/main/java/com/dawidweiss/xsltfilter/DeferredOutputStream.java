...
/**
 * Implementation of a {@link javax.servlet.ServletOutputStream} that buffers all the output in
...
final class DeferredOutputStream extends ServletOutputStream {
     ...
     * 
     * @see #passthrough(java.io.OutputStream)
     */
    ...
    /**
     * Sets an {@link java.io.IOException} to be thrown on next call to any
