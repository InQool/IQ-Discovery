...
/**
 * A wrapper around a {@link javax.servlet.http.HttpServletResponse} which attempts to detect
...
final class XsltFilterServletResponse extends HttpServletResponseWrapper {
    ...
    /** 
     * The actual {@link javax.servlet.http.HttpServletResponse}.
     */
    private HttpServletResponse origResponse = null;

    /**
     * The actual {@link javax.servlet.http.HttpServletRequest}.
     */
    private HttpServletRequest origRequest;

    /**
     * The {@link javax.servlet.ServletOutputStream} returned from {@link #getOutputStream()} or
     * <code>null</code>.
     */
    private ServletOutputStream stream = null;

    /**
     * The {@link java.io.PrintWriter} returned frmo {@link #getWriter()} or <code>null</code>.
     */
     ...
     * wrapping a given {@link javax.servlet.http.HttpServletResponse}.
     * 
     * @param response The original chain's {@link javax.servlet.http.HttpServletResponse}.
     * @param request  The original chain's {@link javax.servlet.http.HttpServletRequest}.
