...
public class DbConfigurationProvider implements Configuration {
  ...
  public void initialise() throws ConfigurationException {
    ...
    if ( backend_plugins != null ) {
      for ( Iterator i = backend_plugins.entrySet().iterator(); i.hasNext(); ) {
    ...
    if ( qb_plugins != null ) {
      for ( Iterator i = qb_plugins.entrySet().iterator(); i.hasNext(); ) {
        Map.Entry e = (Map.Entry) i.next();
    ...
    if ( ( svc != null ) && ( svc.svc_code != null ) ) {
      ...
      try {
        ...
        if ( svc.properties != null ) {
          for ( Iterator i = svc.properties.entrySet().iterator(); i.hasNext(); ) {
            Map.Entry e = (Map.Entry) i.next();
            if ( e != null ) {
        ...
        if ( svc.collections != null ) {
         for ( Iterator i = svc.collections.iterator(); i.hasNext(); ) {
        ...
        if ( svc.valid_indexes != null ) {
          for ( Iterator i = svc.valid_indexes.entrySet().iterator(); i.hasNext(); ) {
            Map.Entry e = (Map.Entry) i.next();
            if ( e != null ) {
              String prop_name = e.getKey().toString();
              ...
              for ( Iterator i2 = prop_value.iterator(); i2.hasNext(); ) {
