  ...
  public static void main(String[] args) {
    if ( args.length < 1 ) {
      ...
      try {
        ...
        // Dictionary Entries
        for ( Iterator i = dictionary.getAllDefs(); i.hasNext(); ) {
        ...
        for ( Iterator i3 = qm_to_sql_config.getDatabaseMappings(); i3.hasNext(); ) {
        ...
        // Entity Attr Maps
        for ( Iterator i2 = qm_to_sql_config.getEntityAttrMaps(); i2.hasNext(); ) {
        ...
        // Templates
        for ( Iterator i4 = templates.getTemplates(); i4.hasNext(); ) {
