...
public class SQLQueryVisitor {
    ...
    public void visit(QueryNode qn) throws IOException,
                                           UnknownAccessPointException,
                                           UnknownCollectionException {
      visit(qn,null);
    }

    public void visit(QueryNode qn, String default_ns) throws IOException,
                                           UnknownAccessPointException,
                                           UnknownCollectionException {
    ...
    public void visit(InternalModelRootNode rn, String default_ns) throws IOException,
                                                       UnknownAccessPointException,
                                                       UnknownCollectionException {
    ...
    public void visit(InternalModelNamespaceNode ns, String default_ns) throws IOException,
                                                            UnknownAccessPointException,
                                                            UnknownCollectionException {
    ...
    public void visit(ComplexNode cn, String default_ns) throws IOException,
                                             UnknownAccessPointException,
                                          UnknownCollectionException {
    ...
    public void visit(AttrPlusTermNode aptn, String default_ns) throws IOException,
                                                    UnknownAccessPointException,
                                                    UnknownCollectionException
    ...
    public void processDateMapping(Restrictable parent,
      ...
      if ( term instanceof Calendar )
        where_bind_vars.add(new java.sql.Date(((Calendar)term).getTime().getTime())); // Add a date
      else if ( term instanceof Date )
        where_bind_vars.add(new java.sql.Date(((Date)term).getTime())); // Add a date
      else
        ...
        for ( Enumeration path_enum = access_path_elements.elements(); path_enum.hasMoreElements(); ) {
          ...
          if ( nextad instanceof DatabaseLinkAttribute ) {
            ...
            if ( child_alias == null ) {
              ...
              for ( Iterator fi = apc.getConstraints().keySet().iterator(); fi.hasNext(); ) {
