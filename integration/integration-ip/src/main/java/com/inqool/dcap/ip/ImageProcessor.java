...
@ConcurrencyManagement(ConcurrencyManagementType.BEAN) //todo is this correct?
public class ImageProcessor {
    ...
    public void process(String url) {
        try {
            ...
            File targetFolder = new File(outputFolder, dataStore.createDeepPath(dataStore.getOnlyIdFromUrl(url)));
