...
public class FailedToLoadException extends Exception implements Serializable {
    ...
    public FailedToLoadException(String message, Throwable cause, boolean enableSuppression, boolean writableStackTrace) {
