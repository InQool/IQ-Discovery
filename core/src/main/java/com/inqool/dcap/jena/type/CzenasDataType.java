 ...
 */
public class CzenasDataType extends BaseDatatype {
    // Singleton
    private static CzenasDataType dataType = new CzenasDataType() ;
    public static CzenasDataType get() { return dataType; }

    /**
     * Constructor.
     *
     */
    public CzenasDataType() {
        super("http://inqool.cz/zdo/1.0/CZENAS");
    }
