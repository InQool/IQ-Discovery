 ...
 */
public class InvIdDataType extends BaseDatatype {
    // Singleton
    private static InvIdDataType dataType = new InvIdDataType() ;
    public static InvIdDataType get() { return dataType; }

    /**
     * Constructor.
     *
     */
    public InvIdDataType() {
        super("http://inqool.cz/zdo/1.0/InvId");
    }
