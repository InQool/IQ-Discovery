 ...
 */
public class UrnNbnDataType extends BaseDatatype {
    // Singleton
    private static UrnNbnDataType dataType = new UrnNbnDataType() ;
    public static UrnNbnDataType get() { return dataType; }

    /**
     * Constructor.
     *
     */
    public UrnNbnDataType() {
        super("http://inqool.cz/zdo/1.0/URNNBN");
    }
