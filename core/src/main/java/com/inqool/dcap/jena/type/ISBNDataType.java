 ...
 */
public class ISBNDataType extends BaseDatatype {
    // Singleton
    private static ISBNDataType dataType = new ISBNDataType() ;
    public static ISBNDataType get() { return dataType; }
     ...
     */
    public ISBNDataType() {
        super("http://inqool.cz/zdo/1.0/ISBN");
    }
