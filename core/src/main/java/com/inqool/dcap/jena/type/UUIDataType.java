 ...
 */
public class UUIDataType extends BaseDatatype {
    // Singleton
    private static UUIDataType dataType = new UUIDataType() ;
    public static UUIDataType get() { return dataType; }
     ...
     */
    public UUIDataType() {
        super("http://inqool.cz/zdo/1.0/UUID");
    }
