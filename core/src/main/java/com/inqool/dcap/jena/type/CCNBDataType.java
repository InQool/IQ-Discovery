 ...
 */
public class CCNBDataType extends BaseDatatype {
    // Singleton
    private static CCNBDataType dataType = new CCNBDataType() ;
    public static CCNBDataType get() { return dataType; }
     ...
     */
    public CCNBDataType() {
        super("http://inqool.cz/zdo/1.0/ISSN");
    }
